object frmRelProdutos: TfrmRelProdutos
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.LastChange = 44930.879822569400000000
  ...
  object FDQuery1: TFDQuery
    ...
    SQL.Strings = (
        ...
        'EMEDIDA = UNIDADEMEDIDA.ID WHERE ((PRODUTO.DESCRICAO LIKE :DESCR' +
        'ICAO) OR (COALESCE(:DESCRICAO, '#39#39') = '#39#39')) AND ((UNIDADEMEDIDA.DE' +
        'SCRICAO LIKE :UNDMEDIDA) OR (COALESCE(:UNDMEDIDA, '#39#39') = '#39#39'))')
    Left = 120
    Top = 72
    ParamData = <
      item
    ...
    object FDQuery1UNDMEDIDA: TStringField
