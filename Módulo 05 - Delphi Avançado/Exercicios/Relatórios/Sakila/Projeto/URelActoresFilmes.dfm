object frmRelAtoresFilmes: TfrmRelAtoresFilmes
  Left = 0
  Top = 0
  ...
  object qryActor: TFDQuery
    ...
    SQL.Strings = (
      'SELECT COUNT(1) quantidade,'#10'       '
      '       film_actor.actor_id,'#10'       '
      '       actor.first_name,'#10'       '
      '       actor.last_name'#10'  '
      '  FROM film_actor'#10'  '
      ' INNER JOIN actor on actor.actor_id = film_actor.actor_id'#10' '
      
        ' WHERE (actor.last_name'#10' LIKE :last_name'#10') or (coalesce(:last_na' +
        'me, '#39#39') = '#39#39')'
      ' GROUP BY film_actor.actor_id,'#10'       '
      '       actor.first_name,'#10'       '
      '       actor.last_name'#10'  '
      ' ORDER BY 1'#10'  ')
    Left = 168
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.LastChange = 44939.767160324100000000
    ...
    object Page1: TfrxReportPage
      ...
      object ReportTitle1: TfrxReportTitle
        ...
        object Memo1: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            'RELAT'#211'RIOS DE ATORES/FILMES')
          ParentFont = False
        end
      end
      ...
      object ReportSummary1: TfrxReportSummary
        ...
        object SysMemo1: TfrxSysMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            'TOTAL   [SUM(<frxDBDataset1."quantidade">,MasterData1)]')
          ParentFont = False
        end
