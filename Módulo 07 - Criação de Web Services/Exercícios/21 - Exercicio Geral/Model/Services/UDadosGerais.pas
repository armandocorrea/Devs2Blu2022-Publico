...
type
  TDadosGerais = class
    ...
    public
      ...
      function ProcurarRegistro(const aIdentificador: Integer): TJSONObject;
...
function TDadosGerais.ProcurarRegistro(const aIdentificador: Integer): TJSONObject;
var
  I: Integer;
  xJSON: TJSONObject;
begin
    ...
    begin
      ...
      begin
        Result := TJSONObject.ParseJSONValue(
          TEncoding.ASCII.GetBytes(xJSON.ToJSON), 0) as TJSONObject;
        Break;
      end;
    end;
  except
    on E: Exception do
      raise Exception.Create('Não foi possível procurar o registro: ' + E.Message);
  end;
end;
